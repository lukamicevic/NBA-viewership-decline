...
export default function App() {
  ...
  const introSteps      = makeSentenceSteps('text-intro', 'intro', './public/images/kobe.png');
  const popularitySteps = makeSentenceSteps('text-popularity', 'popularity', './public/images/msg.png');
  const stateMapSteps   = makeSentenceSteps('text-state-map-teams','state-map-teams','./public/images/celtics.png');
  const feedbackSteps   = makeSentenceSteps('text-feedback', 'feedback', './public/images/kd.png');
  const three1Steps     = makeSentenceSteps('text-three-pointer-1','three-pointer-1','./public/images/harden.png');
  const three2Steps     = makeSentenceSteps('text-three-pointer-2','three-pointer-2','./public/images/steph.png');
  const ppgSteps        = makeSentenceSteps('text-points-per-game','points-per-game','./public/images/lebron.png');
  const conclusionSteps = makeSentenceSteps('text-conclusion', 'conclusion', './public/images/media.png');
