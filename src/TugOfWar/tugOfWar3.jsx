...
const tugData = [
  {
    ...
    negative: [
      ...
      { label: "Over-Commercialization", weight: 1 },
...
const TugOfWar3 = () => {
  ...
  const yearData = tugData.find(d => d.year === 2024);
  ...
  const leftRopeLength = 5 + positiveWeight * 90;
  const rightRopeLength = 5 + negativeWeight * 90;
